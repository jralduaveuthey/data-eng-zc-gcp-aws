...
def execute_pyspark_script(cluster_id, bucket, pyspark_script_s3_key, input_green, input_yellow, redshift_url, redshift_table, aws_access_key_id, aws_secret_access_key):
    emr = boto3.client('emr')
...
# Upload the file to S3
    local_file = '06_spark_sql_redshift.py'
    s3_bucket = config['s3_bucket']
    s3_key = 'code/06_spark_sql_redshift.py'
    upload_file_to_s3(s3_bucket, local_file, s3_key)

    # Execute the PySpark script
    pyspark_script_s3_key = 'code/06_spark_sql_redshift.py'
    ...
    step_id = execute_pyspark_script(cluster_id, s3_bucket, pyspark_script_s3_key, input_green, input_yellow, redshift_url, redshift_table, aws_access_key_id, aws_secret_access_key)
